...
from modules.minister_brief      import render as render_minister_brief
...
def render_sidebar():
    with st.sidebar:
        ...
        nav_options = {
            ...
            T("nav_minister_brief"):    "minister_brief",
...
def main():
    ...
    if page == "dashboard":
        ...
        render_evaluation()
    elif page == "minister_brief":
        render_minister_brief(dfs, lang())
